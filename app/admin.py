...
class CartAdmin(admin.ModelAdmin):
    ...
    list_editable = ('customer_id', 'product_id_size', 'cart_quantity', 'cart_complete')
...
class ShippingAdmin(admin.ModelAdmin):
    ...
    search_fields = ['shipping_phonenumber']
    ...
    list_editable = ('order_id', 'first_name', 'last_name', 'shipping_email', 'shipping_address', 'shipping_phonenumber', 'shipping_description')
...
class EmployeeAdmin(admin.ModelAdmin):
    ...
    list_editable = ('emp_name', 'emp_age', 'emp_address', 'emp_phonenumber', 'emp_email', 'emp_position', 'Status_of_work')
...
class ProductAdmin(admin.ModelAdmin):
    ...
    list_editable = ('product_name', 'product_description', 'product_size', 'product_image', 'product_price', 'category_id', 'product_id')
...
class CustomerAdmin(admin.ModelAdmin):
    ...
    list_editable = ('customer_name', 'customer_address', 'customer_phonenumber', 'customer_email')
...
class OrderAdmin(admin.ModelAdmin):
    ...
    list_editable =('customer_id', 'order_date', 'order_total')
...
class OrderDetailsAdmin(admin.ModelAdmin):
    ...
    list_editable = ('order_id', 'product_id_size', 'order_detail_quantity', 'order_detail_total')
...
class RevenueAdmin(admin.ModelAdmin):
    ...
    list_editable = ('revenue_month', 'revenue_Total')
